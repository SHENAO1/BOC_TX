...
按 P0–P7 分阶段推进，当前处于 **P0-A 参数级自洽检查已通过、P0-B 硬件预检已完成且待频谱仪接入、P1 可软件先行** 阶段。
...
- 进行中：`P0-B` 正式 CW 单峰、DC、镜像和 2 分钟稳定性验证待频谱仪接入；若当前仍不接硬件观测链路，软件路线可转入 `P1`
- 阻塞项：当前 USRP 未连接频谱仪，`P0-B` 的必需验收项尚未完成
